...
#anDREW/GEORGE to set the names to keep
players.to.show <- c("LeBron James", "Carmelo Anthony", "Gerald Henderson",
                     "Taurean Waller-Prince", "Shelvin Mack", "Devin Booker",
                     as.character(sample(nba$Player[seq(2, 486, 6)], 10)))
=======
#JOE TO FIX THIS
...
>>>>>>> b229e3f697e2aa57de09838ef0dd7be00be27515
```
...
salary.diff.df <- nba %>%
  ...
  mutate(Salary_diff = (Clust_Salary - Salary) / 1000000,
         ...
         Label = if_else(Player %in% players.to.show, Player, "")) %>% 
  arrange(Salary_diff)
