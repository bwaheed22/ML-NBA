---
title: "ML Final Project: Data Cleanup"
...
There is a record for each team a player was on. For example, Ersan Ilysaova played on 3 teams in 2017, so there are three rows. To work around this, we will just assign the team the player has played the most minutes on to their total ('TOT') row. For Ilysasova, this would be PHI since he played the most minutes there vs. his other teams.
